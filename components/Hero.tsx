  ...
  return (
    <section className="relative h-dvh w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-white/10 dark:bg-white/5 rounded-full blur-3xl animate-float"
          style={{ animationDelay: '2s' }}
        />
        <div
          className="absolute top-1/2 left-1/3 w-64 h-64 bg-white/10 dark:bg-white/5 rounded-full blur-3xl animate-float"
